...
urlpatterns = [
    ...
    path("movies/recommends/", views.RecommendationsMoviesApi.as_view(), name='recommended_movies_list'),
    path("movies/by_user_genres/", views.ByUserGenresMoviesApi.as_view(), name='by_user_genres_movies_list'),
